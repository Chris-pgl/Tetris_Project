...
//QUI CREIAMO LA STRUTTURA DEL GIOCO, LO SFONDO NERO, LE RIGHE ECC.
public class Board extends JPanel implements KeyListener, MouseListener, MouseMotionListener {
    ...
    //quanti blocchi abbiamo (per ora 7)
    ...
    //Qui sto sistemando il bordo del gioco, il black screen di sfondo
    @Override
    protected void paintComponent(Graphics g) {
        ...
        //Qui faccio il bordo righe bianche orizzontali
        g.setColor(Color.white);
        for (int row = 0; row < BOARD_HEIGHT; row++) {
            g.drawLine(0, BLOCK_SIZE * row, BLOCK_SIZE * BOARD_WIDTH, BLOCK_SIZE * row);
        }
        // righe bordo bianche verticali
    ...
    public void keyPressed(KeyEvent e) {
        ...
        //clean the board e start again with space
        if (state == STATE_GAME_OVER){
